...
- Once per hour: FMP stable API (PEG, ROE, margins, growth) — 250 calls/day limit
                 yfinance (analyst recommendations + price targets + beta) — unlimited

Tickers are US-listed ADRs/dual listings for consistent FMP + Yahoo coverage:
  GSK, RHHBY, ASML, NSRGY, NVS, NVO, LRLCY, LVMUY, AZN, SAP, SNY
"""
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "..", "data", "granolas.json")
TICKERS   = ["GSK", "RHHBY", "ASML", "NSRGY", "NVS", "NVO", "LRLCY", "LVMUY", "AZN", "SAP", "SNY"]
...
# ── yfinance (analyst recommendations + price targets + beta) ─────────────────
